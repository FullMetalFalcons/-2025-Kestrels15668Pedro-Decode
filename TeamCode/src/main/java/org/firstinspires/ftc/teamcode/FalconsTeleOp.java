...
public class FalconsTeleOp extends OpMode {
    ...
    public static double offsetY, offsetX;
    public static double closeVel =  1800, farVel = 2140;
    public static double SERVO_CLOSE = 0.27, SERVO_OPEN = 0.435;
    public static double expoX = 0.4, expoY = 0.4, expoAng = 0.6;
    ...
    public void init() {
        ...
        double xOffset = offsetY;
        double yOffset = offsetX;
