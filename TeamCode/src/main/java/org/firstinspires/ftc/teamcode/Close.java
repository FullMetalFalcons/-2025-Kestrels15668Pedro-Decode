...
public class Close extends OpMode {
    ...
    public void buildPaths() {
        ...
        intakePathReady1 = follower.pathBuilder()
                .addPath(new BezierLine(  launchPose, /*intake1ControlPoint,*/ intake1ReadyPose  ))
        ...
        launchPath4 = follower.pathBuilder()
                .addPath(new BezierLine(intake3FinishPose, /*launch4ControlPoint,*/ launchPose))
...
/*
            ...
            case 5:
                if (!follower.isBusy()) {
                    ...
                    outtake.FLY_WHEELS_RUNNING = true;
                    outtake.setLauncherVelocity(outtake.velocityRpm);*/
